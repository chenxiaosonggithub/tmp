...
现在的最后一个补丁，重新写commit message，标题类似smb/client: use stack-allocated smb2_file_all_info in smb3_query_mf_symlink()，正文写得通俗易懂些，词汇用最简单的，要像是非英语母语的人写的，每行最多75字符。

现在的最后一个补丁，重新写commit message，写得通俗易懂些，词汇用最简单的，要像是非英语母语的人写的，每行最多75字符。
```
